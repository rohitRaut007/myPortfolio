    ...
    <div style={{ maxWidth: "100%", color: "var(--c-text-2)" }}>
      ...
      <div style={{ marginBottom: "16px" }}>
        ...
        >
          ...
          Available &middot; Open to Full-Time &amp; Contract
        </span>
      </div>
      ...
      {/* Name — original desktop clamp preserved, min raised for mobile impact */}
      <h1 style={{
      ...
      {/* Body */}
      <p style={{
        margin: "16px 0 0", maxWidth: "min(480px, 100%)",
        fontSize: "clamp(13px, 2vw, 15px)", lineHeight: 1.7, color: "var(--c-text-3)",
      ...
      {/*
        CTAs — stack to full-width column on mobile (< 500px),
        revert to auto-width row on sml+ (500px+) and desktop.
        No inline width style on buttons so Tailwind w-full/w-auto wins.
      */}
      <div className="flex flex-col sml:flex-row gap-3 mt-5">
        <Link to="contact" smooth offset={-70} duration={500} className="block sml:inline-block">
          <button
        ...
        <a
          ...
          className="block sml:inline-block"
        >
          <button
            className="w-full sml:w-auto"
            style={{
      ...
      <div style={{ marginTop: "16px" }}>
        <div style={{
          fontFamily: JET, fontSize: "10px", letterSpacing: "0.12em",
          color: "var(--c-border-s)", marginBottom: "8px", textTransform: "uppercase",
        }}>
          Find me in
        </div>
